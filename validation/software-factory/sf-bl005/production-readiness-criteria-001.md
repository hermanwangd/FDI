...
| G4 — Previously unseen formal holdout | Holdout selected and sealed after the final candidate, scorer, thresholds, and selection protocol are frozen; no reuse for development/calibration; precision strictly >0.80 and recall strictly >0.60; all denominators and unavailable values explicit | Protocol revision 1 is prepared and independently reviewed PASS, without repository/sample/gold disclosure. H0 final candidate, H1 scorer, H2 contamination ledger, external protocol seal, selection, truth, envelope, dispatch, and execution remain missing. | **MISSING** |
