...
| --- | --- |
| Workflow Lead | `docs/overview/FDI-PROJECT-OVERVIEW.md`, Layer 1 approved specs, root Layer 1 Skills |
| Feature Investigator | `skills/ft-t2/*`, `contracts/ft-t2/*`, `workflows/ft-t2/FEATURE-CLOSURE.md` |
| Closure Reviewer | `skills/ft-t2/closure-review/SKILL.md`, `ClosureReview` contract |
