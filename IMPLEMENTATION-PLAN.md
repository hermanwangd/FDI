...
## H2 comparator implementation

User selected implementing the H2 comparison tool and rules. Backlog SF-BL-005; requirements SF-EVAL-001/EVID-001/TECH-001; base e7608776eb956e3007b632b087be657f7ec2f391. Design: validation/software-factory/sf-bl005/h2-comparator-001/DESIGN.md. Execution owns new H2ExposureComparator.java in product/realization/contamination/v1, application/H2ExposureCompareCli.java, and application/H2ExposureCompareCliTests.java. FDP owns controls and this evidence namespace. Existing producer/scorer, frozen H0/H1 receipts, protocol and ledger remain read-only.

Use TDD: synthetic exact match, similarity/unknown, malformed input, deterministic CLI and resource boundary tests RED first. Implement exact digest verification plus deterministic5-token Jaccard review signal; no automatic NO_MATCH, no new repositories. Run targeted, full Java17 (approved pinned RealWorld and selector regression inputs), Python regression, repeated CLI fixture outputs, independent code/evidence review. Maven2GB, one fork1GB, aggregate below8GB. Record exact code/policy/binary hashes. Delivery of this diagnostic comparator does not complete H2 disclosure, bind semantic independence thresholds, authorize selection or alter the frozen709 H0/H1 runtime.
