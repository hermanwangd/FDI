...
`SF-BL-005-FORMAL-HOLDOUT-SCORER-001` is selected by Human option 1. Run immutable r4 `validation/software-factory/sf-bl005/execution-envelope-formal-holdout-scorer-001-r4.json` (integrated `09053f393f8f8453008577b5e76366c460d9fce1`) under `formal-holdout-scorer-001/r4-human-dispatch-001.json` in that evidence directory. Candidate `ea15e51df0f5410bfb5532e1c255f107ccb0975b`, control/base, argv, stage order, frozen artifacts, acceptance and 8GB/Java17 limits remain exact r4 bindings. Execute three phases once, fail-stop, retain all receipts/logs and independently review results. Owned outputs: r4 executionRoot and `validation/software-factory/sf-bl005/formal-holdout-scorer-001/r4-execution-001/`; candidate source is immutable. H1 remains unbound pending execution review and separate candidate merge decision. Calibration, repository selection, holdout access and production readiness remain unauthorized.
