...
H1 retains the first `FAIL_PLAN_CONFLICT`. The Human decision receipt is `validation/software-factory/sf-bl005/formal-holdout-scorer-001/macro-rounding-human-decision-001.json`. Revision 2, verifier, R02, manifest, and 60-vector review now agree on raw-ratio macro recall `0.783333333333`; independent review passed. Candidate `ea15e51df0f5410bfb5532e1c255f107ccb0975b` remains non-executable and H1 remains unbound until reseal integration and a new exact envelope. No execution, calibration, dispatch, or holdout access is authorized.
