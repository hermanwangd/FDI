...
- `SF-BL-005-RESTASSURED-STATUS-DIALECT-001` — `PREFLIGHT_PASS_PR_INTEGRATED_DISPATCH_READY`; implementation and dispatch are authorized and both preflight/integration gates are satisfied.
