...
│
├── docs/overview/FDI-PROJECT-OVERVIEW.md ← START HERE
├── README.md                           ← package usage / local commands
├── agent/handoff/MULTICA-HANDOFF.md    ← continuation instructions
├── docs/planning/DEVELOPMENT-BACKLOG.md ← ordered work
├── docs/planning/STATUS.json           ← current machine state
│
...
7. Relevant `docs/specifications/`, `contracts/`, and `skills/` for the task being changed.
8. `agent/handoff/MULTICA-HANDOFF.md` — continue execution in Multica.
