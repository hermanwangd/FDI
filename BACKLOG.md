...
| `SF-BL-005` | `FEATURE` | `AUTH-002`, `PK-004`, `EVID-001`, `SF-EVAL-001`, `TECH-001`; source: SF-BL-002 post-acceptance analysis | Align scenario-mapping scoring units, strengthen evidence-backed METHOD realization chains, and compare baseline/improved producers on isolated unseen data under one frozen protocol. Keep TYPE limitations explicit and outputs proposal-only. | `IN_PROGRESS` | Combined runner/ancestor replay `8c294063d6696a567bbd1c29552e0fd6925e0f73` is `ENGINEERING_READY`; intake: `validation/software-factory/sf-bl005/runner-ancestor-integration-001/intake.json`. Human selected diagnostic-only RealWorld execution `SF-BL-005-REALWORLD-SELECTOR-DIAGNOSTIC-001`; fresh envelope is pending. REALWORLD-003 remains withheld and immutable. Plan: `IMPLEMENTATION-PLAN.md#current-selection`. Calibration, formal holdout and parent closure remain gated. |
