...
| `PKB-BL-011` | `VALIDATION` | `PKB-EVAL-002` | Separate scenario, chain, component, and diagnostic measures. | `IN_PROGRESS` | BL-007 and BL-010 are verified. Selected execution adds a deterministic hierarchical Forward evaluation report without choosing acceptance thresholds. |
