...
| `SF-BL-002` | `BUG` | `AUTH-002`, `PK-004`, `EVID-001`, `TECH-001`; source: immutable PKB-BL-007/011 `REVISE` evidence | Correct the misleading unresolved-reference denominator, recover only mechanically provable production receiver references, and enable evidence-backed scenario mapping without treating external/test-helper calls or proposals as Product truth. | `IN_PROGRESS` | Production-reference checkpoint PASS. Successor execution `SF-BL-002-PRODUCTION-SCENARIO-002` delegates Plan Tasks 3–6 to the Execution Plane from exact base `13890ccff85fa7b2f79341a2c7439cac02059f87`. Evidence: `validation/software-factory/sf-bl002/remediation-evidence.json`. |
