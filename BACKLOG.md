...
`SF-BL-005-ROUTE-COVERAGE-ANALYSIS-001` proposal below; design approval does
not select or authorize its execution.
...
envelope and separate Human selection are required before execution.
