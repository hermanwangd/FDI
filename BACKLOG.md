...
| `PKB-BL-009` | `FEATURE` | `PKB-REVERSE-001` | Reduce duplicate, over-combined, and overclaimed reverse proposals. | `IN_PROGRESS` | Selected by `IMPLEMENTATION-PLAN.md#pkb-bl-009-reverse-advisory-quality`; frozen defect ledger remains evaluator-only. |
